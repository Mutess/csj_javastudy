...
public class 사용자정의_데이터형_4 {
	public static void main(String[] args) {
		 ...
		 * 한메모리에 여러개 다른 데이터형을 모아서 관리
		 * 데이터 관리
		 */
		Music[] music = new Music[50];
		//int[] arr = new int[50]; 이거랑 같음 //클래스를 데이터형으로 봐야됨
		...
		int i = 1;
		for (Music m:music) {/////////////////////////////for (int i:arr) 이거랑 같음
			System.out.println(i+"."+m.title);
			i++;
		}
		Scanner scan = new Scanner(System.in);
		System.out.print("자세히 볼 노래를 선택 : ");
		int no = scan.nextInt();
		...
		//상승이 가장 많은 노래
		System.out.println("=== 상승이 가장 많은 노래 ===");
		int max = 0;
		int index = 0;
