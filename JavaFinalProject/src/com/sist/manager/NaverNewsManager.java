...
public class NaverNewsManager {
    ...
    public static List<NewsVO> newsSearchData(String fd) {
        ...
        String clientId = "rfqNZPIw10Z3cdb3gOTx"; //애플리케이션 클라이언트 아이디
        String clientSecret = "8TrVpwxvTF"; //애플리케이션 클라이언트 시크릿
        ...
        String apiURL = "https://openapi.naver.com/v1/search/news.json?display=7&query=" + text;    // JSON 결과 //display=10가지고 오는 갯수
